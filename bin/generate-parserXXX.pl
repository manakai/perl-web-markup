...
sub _expanded_tokenizer_defs ($) {
  my $expanded_json_path = $DefDataPath->child
      ('../../../../../data-web-defs/data/xml-tokenizer-expanded.json');
#XXX      ('html-tokenizer-expanded.json');
  return json_bytes2perl $expanded_json_path->slurp;
} # _expanded_tokenizer_defs

sub _parser_defs ($) {
  my $expanded_json_path = $DefDataPath->child
      ('../../../../../data-web-defs/data/xml-tree-constructor-expanded.json');
#XXX      ('html-tree-constructor-expanded-no-isindex.json');
  return json_bytes2perl $expanded_json_path->slurp;
} # _parser_defs
