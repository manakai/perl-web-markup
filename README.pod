...
submodule of the Git repository.  The L<Web::RDF::XML::Parser> module
has more submodule dependency (see its documentation for details).
...
modules, see L<Web::XPath::Evaluation> for its requirements on the DOM
...
Perl Binding, and manakai's DOM Extensions, to the extent implemented
by the "NanoDOM" module (C<t_deps/lib/NanoDOM.pm>).  An example of
such a DOM implementation is contained in the perl-web-dom package
<https://github.com/manakai/perl-web-dom>.

The L<Web::HTML::Validator> module requires additional external
modules; see its documentation.
...
"Whatpm" in 2007-2008
<http://suika.suikawiki.org/www/markup/html/whatpm/readme> and then
merged into the manakai-core package
<http://suika.suikawiki.org/www/manakai-core/doc/web/>.  Those modules
are split again into this separate package in 2013.
...
Known issues are recorded at: <http://manakai.g.hatena.ne.jp/task/4/>.
