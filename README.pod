...
The L<Web::Feed::Parser> module requires modules from
perl-web-datetime <https://github.com/manakai/perl-web-datetime> and
perl-web-url <https://github.com/manakai/perl-web-url> packages.
