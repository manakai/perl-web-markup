...
XXX XML-DOM mapping is not fully defined.

The C<xmlns> attribute in an XML document MUST be mapped to an C<Attr>
object whose namespace is the XMLNS namespace and name is C<xmlns>.
...
<http://suika.suikawiki.org/www/markup/xml/xmlcc/xmlcc-work>.

XXX This document is out of date.
