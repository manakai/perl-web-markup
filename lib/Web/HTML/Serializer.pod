...
=head1 SYNOPSIS
  ...
  my $html = Web::HTML::Serializer->get_inner_html ($el);
      ## NOTE: $html = $el->inner_html is preferred.
  
  ## Serialize an HTML document fragment
  my $html = Web::HTML::Serializer->get_inner_html ($df);
...
=item I<$html> = Web::HTML::Serializer->get_inner_html (I<$node>, [I<$onerror>])
...
Web <http://suika.fam.cx/www/markup/html/whatpm/readme>.
...
L<Whatpm::HTML::Serializer> module, from which the
C<Web::HTML::Serializer> module derived.
