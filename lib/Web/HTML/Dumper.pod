...
Web::HTML::Dumper - Dump DOM tree by the parser test format
...
The C<Web::HTML::Dumper> exports a function, C<dumptree>, which
...
(i.e. an instance of L<Web::DOM::Document> class).  The function
...
<http://wiki.whatwg.org/wiki/Parser_tests#Tree_Construction_Tests> and
...
key-value pair to the C<%$Web::HTML::Dumper::NamespaceMapping>
hash:
