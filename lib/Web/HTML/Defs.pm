...
sub ENTITY_ENTITY_VALUE_STATE () { 133 }
...
sub PARAMETER_ENTITY_NAME_STATE () { 130 }
sub PARAMETER_ENTITY_DECL_OR_NAME_STATE () { 131 }
sub EXTERNAL_PARAM_ENTITY_STATE () { 94 }
sub EXTERNAL_PARAM_ENTITY_TAG_STATE () { 132 }
sub AFTER_MSS_STATE () { 134 } ## Not in XML5
sub BEFORE_STATUS_KEYWORD_STATE () { 135 } ## Not in XML5
sub STATUS_KEYWORD_STATE () { 136 } ## Not in XML5
sub AFTER_STATUS_KEYWORD_STATE () { 137 } ## Not in XML5
sub MSC_STATE () { 138 } ## Not in XML5
sub AFTER_MSC_STATE () { 139 } ## Not in XML5
sub IGNORED_SECTION_STATE () { 140 } ## Not in XML5
sub IGNORED_SECTION_TAG_STATE () { 141 } ## Not in XML5
sub IGNORED_SECTION_MD_STATE () { 142 } ## Not in XML5
sub ENTITY_VALUE_ENTITY_NAME_STATE () { 143 } ## Not in XML5 # last
...
push @EXPORT, qw(
  ...
  DOCTYPE_ENTITY_VALUE_SINGLE_QUOTED_STATE ENTITY_ENTITY_VALUE_STATE
  ...
  PARAMETER_ENTITY_DECL_OR_NAME_STATE
  EXTERNAL_PARAM_ENTITY_STATE EXTERNAL_PARAM_ENTITY_TAG_STATE
  AFTER_MSS_STATE BEFORE_STATUS_KEYWORD_STATE STATUS_KEYWORD_STATE
  AFTER_STATUS_KEYWORD_STATE MSC_STATE AFTER_MSC_STATE
  IGNORED_SECTION_STATE IGNORED_SECTION_TAG_STATE IGNORED_SECTION_MD_STATE
  ENTITY_VALUE_ENTITY_NAME_STATE
);
