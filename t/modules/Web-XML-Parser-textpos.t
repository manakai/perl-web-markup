...
for my $test (
  ...
  [q{<!DOCTYPE p[
    <!ENTITY ltv "fo&amp;o">
                                 ...
                                 [2, 2, 1, 1, undef, [[0, 2, 2, 19, 0], [3, 1, 2, 22, 0], [3, 5, 2, 22, 0]]], # fo
                                 [4, 1, 1, 3, undef, [[0, 2, 2, 19, 0], [3, 1, 2, 22, 0], [3, 5, 2, 22, 0]]], # &amp;
                                 [5, 1, 1, 8, undef, [[0, 2, 2, 19, 0], [3, 1, 2, 22, 0], [3, 5, 2, 22, 0]]], # o
                                 [6, 1, 3, 21]], 3, 8, undef], # x
  [q{<!DOCTYPE p[
    <!ENTITY ltv "fo&abc;o">
  ]><p hoge="ab&ltv;x"></p>} => [[0, 2, 3, 14], # ab
                                 [2, 2, 1, 1, undef, [[0, 2, 2, 19, 0], [3, 1, 2, 22, 0], [3, 5, 2, 22, 0]]], # fo
                                 [4, 5, 1, 3, undef, [[0, 2, 2, 19, 0], [3, 1, 2, 22, 0], [3, 5, 2, 22, 0]]], # &abc;
                                 [9, 1, 1, 8, undef, [[0, 2, 2, 19, 0], [3, 1, 2, 22, 0], [3, 5, 2, 22, 0]]], # o
                                 [10, 1, 3, 21]], 3, 8, undef], # x
  [q{<!DOCTYPE p[
    <!ENTITY abc SYSTEM "foo" aa>
    <!ENTITY ltv "fo&abc;o">
  ]><p hoge="ab&ltv;x"></p>} => [[0, 2, 4, 14], # ab
                                 [2, 2, 1, 1, undef, [[0, 2, 3, 19, 0], [3, 1, 3, 22, 0], [3, 5, 3, 22, 0]]], # fo
                                 [4, 5, 1, 3, undef, [[0, 2, 3, 19, 0], [3, 1, 3, 22, 0], [3, 5, 3, 22, 0]]], # &abc;
                                 [9, 1, 1, 8, undef, [[0, 2, 3, 19, 0], [3, 1, 3, 22, 0], [3, 5, 3, 22, 0]]], # o
...
for my $test (
  ...
  [q{<!DOCTYPE a [
    ...
    <!ATTLIST a bb CDATA "dd&foo;b">
                     ...
                     [2, 1, 1, 1, undef, [[0, 1, 3, 19, 0], [2, 1, 3, 21, 0], [2, 3, 3, 21, 0]]], # b
                     [3, 1, 2, 17, 0],
                     [4, 1, 1, 5, undef, [[0, 1, 3, 19, 0], [2, 1, 3, 21, 0], [2, 3, 3, 21, 0]]], # c
                     [5, 1, 4, 34]],
   4, 17, undef],
  [q{<!DOCTYPE a[
    <!ENTITY a "<a hoge='foo'></a>">
  ]><b>&a;</b>} => [[0, 3, 1, 10, undef, [[0, 18, 2, 17, 0]]]], 2, 20, 0],
  [q{<!DOCTYPE a[
    <!ENTITY a "<a hoge='foo'></a>">
    <!ENTITY b "&a;">
  ]><b>&b;</b>} => [[0, 3, 1, 10, undef, [[0, 18, 2, 17, 0]]]], 2, 20, 0],
  [q{<!DOCTYPE a[
    <!ENTITY a "<a hoge='fo&c;'></a>">
    <!ENTITY b "&a;">
    <!ENTITY c "p">
  ]><b>&b;</b>} => [[0, 2, 1, 10, undef, [[0, 11, 2, 17, 0], [12, 1, 2, 29, 0], [12, 8, 2, 29, 0]]],
                    [2, 1, 4, 17, 0]], 2, 20, 0],
) {
  test {
    my $c = shift;
